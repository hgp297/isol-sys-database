...
# #### cbf tfp
# run_case = 'cbf_tfp_moderate_spectracomments'
...
# #### mf tfp
# run_case = 'mf_tfp_moderate_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
...
# #### cbf lrb
# run_case = 'cbf_lrb_moderate_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
...
# #### mf lrb
# run_case = 'mf_lrb_moderate_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
...
# #### cbf tfp
# run_case = 'cbf_tfp_enhanced_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
...
# #### mf tfp
# run_case = 'mf_tfp_enhanced_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
...
# #### cbf lrb
# run_case = 'cbf_lrb_enhanced_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
...
# #### mf lrb
# run_case = 'mf_lrb_enhanced_spectracomments'
# validation_path = '../data/validation/'+run_case+'/'
# loss_path = '../data/validation/'+run_case+'/'
