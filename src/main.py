...
import pickle
loss_path = '../data/loss/'
with open(loss_path+'structural_db_complete_spectracomments_loss.pickle', 'wb') as f:
    pickle.dump(main_obj, f)
