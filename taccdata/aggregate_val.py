...
agg_data('mf_tfp_moderate_spectracomments')
agg_data('mf_lrb_moderate_spectracomments')
agg_data('cbf_tfp_moderate_spectracomments')
agg_data('cbf_lrb_moderate_spectracomments')

agg_data('mf_tfp_enhanced_spectracomments')
agg_data('mf_lrb_enhanced_spectracomments')
agg_data('cbf_tfp_enhanced_spectracomments')
agg_data('cbf_lrb_enhanced_spectracomments')